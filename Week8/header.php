...
<li class="nav-item" role="presentation">
            <a class="nav-link active rounded-5" href="wk8ex1.php" id="home-tab2"  type="button" role="tab" aria-selected="true">EX1 </a>
          </li>
          <li class="nav-item" role="presentation">
            <a class="nav-link active rounded-5" href="wk8ex2.php" id="profile-tab2"  type="button" role="tab" aria-selected="true">EX2 </a>
          </li>
          <li class="nav-item" role="presentation">
              <a class="nav-link active rounded-5" href="wk8ex3.php" id="profile-tab2"  type="button" role="tab" aria-selected="true">EX3 </a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="nav-link active rounded-5" href="wk8ex4.php" id="profile-tab2"  type="button" role="tab" aria-selected="true">EX4 </a>
            </li>
