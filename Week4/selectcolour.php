...
<form action="confirmation.php" method="post">
  <div class="form-group">
    <label for="selcolour">Select the colour for the <?php echo $_POST['selsize']; ?> widgets you are ordering:</label>
    <select class="form-control" id="selcolour" name="selcolour">
      <option>white</option>
      <option>red</option>
