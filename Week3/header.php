...
<li class="nav-item" role="presentation">
              <a class="nav-link active rounded-5" href="wk3ex1.php" id="home-tab2"  type="button" role="tab" aria-selected="true">EX1</a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="nav-link active rounded-5" href="wk3ex2.php" id="profile-tab2"  type="button" role="tab" aria-selected="true">EX2</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link active rounded-5" href="wk3ex3.php" id="profile-tab2"  type="button" role="tab" aria-selected="true">EX3</a>
              </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link active rounded-5" href="wk3ex4.php" id="home-tab2"  type="button" aria-selected="true">EX4</a>
              </li>
