...
<li class="nav-item" role="presentation">
              <a class="nav-link active rounded-5" href="monsterform.html" id="home-tab2"  type="button" role="tab" aria-selected="true">EX1 Upload</a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="nav-link active rounded-5" href="displaymonster.php" id="profile-tab2"  type="button" role="tab" aria-selected="true">EX2 Display</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link active rounded-5" href="combined.php" id="profile-tab2"  type="button" role="tab" aria-selected="true">EX3 Combined</a>
              </li>
